...
const char* REPLACE_SAVE_FILE = "SavedRegexReplacementsTranslatedText.txt";
...
bool ProcessSentence(std::wstring& sentence, SentenceInfo sentenceInfo)
{
	...
	for (const auto& [regex, replacement, flags] : replacements) sentence += std::regex_replace(sTranslated, regex, replacement, flags);
	return true;
}
